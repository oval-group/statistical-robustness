...
from exp_6_4.attacks import _pgd
...
def train_robust(loader, model, opt, epsilon, epoch, log, verbose, 
    ...
    # DEBUG: Just making sure all correct types
    #print('types in train_robust', type(errors.avg), type(losses.avg), type(robust_errors.avg), type(robust_losses.avg))
    #raise Exception()

    return errors.avg, losses.avg, robust_errors.avg, robust_losses.avg
...
def evaluate_robust(loader, model, epsilon, epoch, log, verbose, 
    ...
    # DEBUG: Just making sure all correct types
    #print('types in test_robust', type(errors.avg), type(losses.avg), type(robust_errors.avg), type(robust_losses.avg))
    #raise Exception()
